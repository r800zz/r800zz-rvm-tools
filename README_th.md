...
[README , สำหรับระบบปฏิบัติการแบบ Unix(Linux , WSL , macOS)](README_sh_th.md)

## ประวัติการอัปเดต

### 17 กันยายน 2026

* แก้ไขการแสดงผลพื้นหลังในโหมดอัลฟา
* เพิ่มสคริปต์ Bash สำหรับระบบปฏิบัติการแบบ Unix (Linux, WSL, macOS)


## คู่มือใช้งานแบบย่อ (Windows)
